...
// checkbrowser polyfills for ES5 array support in IE8- -- via MDN...
...
var checkbrowser = (function (ns, $) {
  ...
  ns.rules = [
    ...
    {
      title: 'ShrubFrog QI discontinued support of versions 9.0, 10.0 of ' +
...
// Other integration JS:

(function ($) {
  $(document).ready(function () {
    console.log('Welcome to ShrubFrog QI, by Mostscript');
  });
}(jQuery));
